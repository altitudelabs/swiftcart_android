...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private void addTab(final int position, View tab) {
		...
		tab.setPadding(getResources().getDimensionPixelSize(R.dimen.pager_tab_strip_tab_padding), 0, getResources().getDimensionPixelSize(R.dimen.pager_tab_strip_tab_padding), 0);
